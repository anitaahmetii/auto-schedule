        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Coordinator_Responsibilities = table.Column<string>(type: "text", nullable: true),
                    AcademicGrade = table.Column<string>(type: "text", nullable: true),
                    lectureType = table.Column<int>(type: "integer", nullable: true),
                    ScheduleTypeId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsLecture = table.Column<bool>(type: "boolean", nullable: false),
                    IsExcercise = table.Column<bool>(type: "boolean", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScheduleType_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseLectures_AspNetUsers_LecturesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Halls_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Halls_Location_LocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LocationDepartment", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LocationDepartment_Location_LocationId",
                        column: x => x.LocationId,
                        principalTable: "Location",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseLectureId = table.Column<Guid>(type: "uuid", nullable: false),
                    CourseLecturesId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Schedules_CourseLectures_CourseLecturesId",
                        column: x => x.CourseLecturesId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Schedules_Halls_HallsId",
                        column: x => x.HallsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_ScheduleTypeId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseLectures_LecturesId",
                table: "CourseLectures",
                column: "LecturesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LocationDepartment_LocationId",
                table: "LocationDepartment",
                column: "LocationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schedules_CourseLecturesId",
                table: "Schedules",
                column: "CourseLecturesId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_ScheduleType_ScheduleTypeId",
                table: "AspNetUsers",
                column: "ScheduleTypeId",
